...
Start with [Quick start](../learn/quick-start.md) and shipped components first. Custom code is easier to reason about when the default path already works.
...
Layer table with examples: [What is aiogram-webhook?](../learn/overview.md#what-each-layer-is-responsible-for).
